const { modifyCharacter, modifyMemory, modifySupport, register, deleteCharacter, createCharacter, lockCharacter, healInjury, shareContacts } = require('../../game/characters');
